...
local globalkeys = gears.table.join(
	...
	end, { description = "screenshot selector", group = "screenshot" }),
	...
	awful.key({ "Control" }, "Print", function()
		awful.spawn("flameshot gui --delay 3000")
	end, { description = "screenshot selector delayed by 3s", group = "screenshot" }),

	awful.key({ "Control", "Shift" }, "Print", function()
		awful.spawn("flameshot full -c --delay 3000")
	end, { description = "fullscreen screenshot delayed by 3s", group = "screenshot" }),

	awful.key({ "Control", "Shift", "Mod1" }, "s", hotkeys_popup.show_help,
