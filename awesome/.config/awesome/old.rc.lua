...
editor = beautiful.editor or os.getenv("EDITOR")
...
local function boxed_widget(widget, bg_color, fg_color)
	return {
		...
		bg = bg_color or beautiful.primary,
		fg = fg_color or beautiful.black,
...
mytextclock = boxed_widget(wibox.widget.textclock("%I:%M"))
...
-- local wifi_widget = boxed_widget(wifi_widget)
local function update_wifi()
	awful.spawn.easy_async_with_shell(
		...
		function(stdout)
			...
			or ("<span foreground='%s'>%s</span>"):format(beautiful.alert, "no-internet")
		)
...
local function update_volume()
	awful.spawn.easy_async_with_shell("wpctl get-volume @DEFAULT_AUDIO_SINK@", function(stdout)
		...
		if mute == "MUTED" then
			volume_widget.markup = "<span foreground='"..beautiful.red.."'>"..volume.."</span>"
		elseif vol then
...
local function update_battery()
	awful.spawn.easy_async_with_shell(
		...
		function(stdout)
			...
			local color = beautiful.secondary
