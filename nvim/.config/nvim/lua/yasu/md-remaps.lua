...
local function set_markdown_folding()
  ...
  vim.opt_local.foldlevel = 99
	vim.opt_local.foldtext = "v:lua.vim.fn.getline(v:foldstart)"
	-- vim.opt_local.foldtext = "v:lua.require'yasu.config.foldtext'.markdown"
	vim.opt_local.fillchars:append({ fold = " " })
	-- vim.cmd([[highlight! link Folded Normal]])
	-- vim.cmd("highlight Folded guifg=#000000 guibg=#000011")
	-- vim.api.nvim_set_hl(0, 'Folded', {
	-- 	fg = require("yasu.config.colors")['linkarzu_color26'],
	-- 	bg = require("yasu.config.colors")['linkarzu_color04'],
	-- 	bold = true,
	-- })
...
--   vim.cmd("normal! za")
--   vim.cmd("normal! zz") -- center the cursor line on screen
-- end, { desc = "[P] fold the heading cursor currently under" })
