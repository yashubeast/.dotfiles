...
return {
	...
	keys = {
		{ "s", mode = { "n", "x", "o" }, function() require("flash").jump() end, desc = "[P] flash" },
		{ "S", mode = { "n", "x", "o" }, function() require("flash").treesitter() end, desc = "[P] flash treesitter" },
		{ "r", mode = "o", function() require("flash").remote() end, desc = "[P] remote flash" },
		{ "R", mode = { "o", "x" }, function() require("flash").treesitter_search() end, desc = "[P] treesitter Search" },
